...
urlpatterns = [
    ...
    path('painel-relatorios/', views.DashboardAnimaisView.as_view(),
         name='painel-relatorios'),
    path('relatorios-concluidos', views.DashboardResolvidosView.as_view(),
         name='relatorios_concluidos'),
    path('relatorio/', views.add_animal, name='registrar'),
    path('painel-relatorios/relatorio-animal/<uuid:pk>',
         views.DashboardAnimalView.as_view(), name='relatorio-animal'),
    ...
    path('atualizar-estado/', views.atualizar_estado_view,
         name='atualizar_estado'),

    # Deletar um relatório
    path('deletar-relatorio/<int:entry_id>/',
         views.deletar_animal_view, name='deletar_relatorio'),
